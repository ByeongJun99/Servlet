...
//		System.out.println(boardTitle);
		...
		if (ServletFileUpload.isMultipartContent(request)) {
			 ...
			 * 
			 * 위 구문 한 줄 싱행만으로 넘어온 첨부파일이 해당 폴더에 무조건 업로드가 된다.
			 * 단, 업로드시 파일명을 수정해줘야한다. 그래서 파일명을 수정시켜주는 객체를 제시해야한다.
			 * => 같은 파일명이 있을 경우 덮어 씌워질 수 있고, 파일명에 한글/특수문자/띄어쓰기가 포함될 경우 서버에 따라 문제 발생
			 * 
			 ...
			 * }
			 * 
			 * 나만의 방식대로 절대 겹치지 않도록 rename 할 수 있게 FileRenamePolicy클래스 만들기
