...
<body>
	...
	<!-- 
		* JSP를 이루는 구성
		 ...
		 3. 액션태그 : jsp 페이지에서 어떤 동작을 하도록 지시하는 태그
	 ...
	 <a href="views/3_Custom_Action_Tag/02_fmt.jsp">02_fmt library</a>
	 
	 <h4>3. JSTL function Library</h4>
	 <p>EL안에서 사용할 수 잇는 메소드를 제공</p>
	 <a href="views/3_Custom_Action_Tag/03_fn.jsp">03_fn library</a>
</body>
</html>